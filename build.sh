...
gcc -D BUILD_SMOGP main.c lib/*.c ./ts_radecoder/*.c ./ao40/long/*.c ./ao40/short/*.c -o smogpgnd/smogpgnd -lm -lpthread -O3 -std=gnu90 #-Wall
gcc -D BUILD_ATL1  main.c lib/*.c ./ts_radecoder/*.c ./ao40/long/*.c ./ao40/short/*.c -o atlgnd/atlgnd     -lm -lpthread -O3 -std=gnu90 #-Wall
