...
void ao40short_decode_data(uint8_t raw[AO40SHORT_RAW_SIZE],
                           uint8_t data[AO40SHORT_DATA_SIZE],
                           int8_t* error);

#ifdef AO40SHORT_DEBUG
void ao40short_decode_data_debug(uint8_t raw[AO40SHORT_RAW_SIZE],
                                 uint8_t data[AO40SHORT_DATA_SIZE],
                                 int8_t* error,
